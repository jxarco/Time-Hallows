...
public:
	...
	void drawImage(const Image& img1, const Image& img2, int x, int y, float factor);
	...
	void drawImage(const Image& img1, const Image& img2, int x, int y, int imgx, int imgy, int imgw, int imgh, float factor); //draws only a part of the image
	...
	void drawImage(const Image& img1, const Image& img2, int x, int y, Area rect, float factor) { drawImage(img1, img2, x, y, rect.x, rect.y, rect.w, rect.h, factor); }//draws only a part of the image
	...
	void drawRectangle(int x, int y, int w, int h, const Color& c, bool fill = true);

	void maskAlpha(const Color& alpha_color); //every pixel with the given color will be set to transparent
	void maskAlpha(int alpha); //every pixel alpha is set to "alpha"
